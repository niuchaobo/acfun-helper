        ...
        <div class="mdui-card-media" style="max-height: 330px">
          ...
          <div class="mdui-card-media-covered">
            ...
            <div class="mdui-card-actions">
              <button class="checkIt mdui-btn mdui-ripple mdui-ripple-white" data-item="topicCard" data-key=${dataKey}>查看</button>
            </div>
          </div>
        </div>
        </div>`
...
async function main() {
  ...
  document.querySelector("body").addEventListener("click", function (e) {
    // console.log(e)
    if (e.target.dataset.item == "topicCard") {
      window.open("/bg/update-log.html?topicId=" + e.target.dataset.key);
    }
  })
}

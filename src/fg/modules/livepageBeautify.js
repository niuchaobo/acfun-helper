...
class LivePageButfy extends AcFunHelperFgFrame {
    constructor() {
        ...
        this.cPIP_span = `
                <span class="btn-span" style="display: block;width: 22px;height: 100%;background-size: contain;background-position: center;background-repeat: no-repeat;background-image: url(${this.cPIP_span_cover});" onclick="LiveFunction.setPictureInPictureMode()"></span> 
                </div>

...
class LivePageButfy {
    ...
    loopToBan(){
        var timer = setInterval(function () {
            ...
            let nod = document.createElement("style");
            let cssStr = ".ban_gift .gift{display:none;} .ban_user-enter .user-enter{display:none;}.ban_like .like{display:none;} .ban_follow .follow{display:none;}"
            nod.type="text/css";
            nod.textContent = cssStr;

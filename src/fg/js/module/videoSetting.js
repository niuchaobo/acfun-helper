...
class VideoSetting{
    constructor(){
        ...
        this.progressBarOptions = {
            id: "achlp-proBar",
            css:
              "display:none;z-index:1000;transition: width 0.4s ease-out;background-color: #fd4c5d;height: 0.5%;position: fixed;bottom: 0px;width: 0%;"
        };
        this.progressBackGroundOptions = {
            id: "achlp-proBar-bg",
            css:
              "display:none;z-index:999;transition: width 0.4s ease-out;height: 0.5%;position: fixed;bottom: 0px;width: 0%;box-shadow:rgb(125,125,125) -3px -1px 5px 0px;"
    ...
    setProgressBarLength(){
        ...
        const a = document.getElementsByClassName('pro-current')[0];
        observerWeb.observe(a, {
            attributes: true,
            attributeOldValue: false,

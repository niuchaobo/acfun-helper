...
class VideoSetting{
    ...
    flexProgressBar(){
        ...
        this.setObserverWeb(sohObserver,throttle(sohObserveFn,110),{ attributefilter :['data-bind-attr']})
        getAsyncDom('pro-current',this.setProgressBarLength.bind(this))
    }
